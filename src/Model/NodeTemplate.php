...
class NodeTemplate implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'removed' => '\DateTime',
        'state' => 'string',
        'status' => '\Rancher\Model\NodeTemplateStatus',
    ...
    /**
     * Gets status
     * @return \Rancher\Model\NodeTemplateStatus
     */
    ...
    /**
     * Sets status
     * @param \Rancher\Model\NodeTemplateStatus $status
     * @return $this
     */
