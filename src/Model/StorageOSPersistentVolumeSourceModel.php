...
/**
 * StorageOSPersistentVolumeSourceModel
 *
 * @category Class
 * @package  Rancher
...
class StorageOSPersistentVolumeSourceModel implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        'fsType' => 'string',
        'readOnly' => 'boolean',
        'secretRef' => '\Rancher\Model\ObjectReferenceModel',
        'volumeName' => 'string',
    ...
    /**
     * Sets secretRef
     * @param \Rancher\Model\ObjectReferenceModel $secretRef
     * @return $this
     */
