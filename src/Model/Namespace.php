...
class Namespace implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'created' => 'date',
        'creatorId' => '\Rancher\Model\User',
        'description' => 'string',
        'labels' => 'string[]',
        'name' => '\Rancher\Model\DnsLabel',
        'ownerReferences' => '\Rancher\Model\OwnerReference[]',
        'projectId' => '\Rancher\Model\Project',
        'removed' => 'date',
        'resourceQuota' => '\Rancher\Model\NamespaceResourceQuota',
        'state' => 'string',
        'transitioning' => 'enum',
    ...
    /**
     * Sets creatorId
     * @param \Rancher\Model\User $creatorId
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param \Rancher\Model\DnsLabel $name
     * @return $this
     */
    ...
    /**
     * Sets projectId
     * @param \Rancher\Model\Project $projectId
     * @return $this
     */
    ...
    /**
     * Sets resourceQuota
     * @param \Rancher\Model\NamespaceResourceQuota $resourceQuota
     * @return $this
     */
