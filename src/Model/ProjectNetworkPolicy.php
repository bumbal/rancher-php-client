...
class ProjectNetworkPolicy implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'removed' => '\DateTime',
        'state' => 'string',
        'status' => '\Rancher\Model\ProjectNetworkPolicyStatus',
    ...
    /**
     * Gets status
     * @return \Rancher\Model\ProjectNetworkPolicyStatus
     */
    ...
    /**
     * Sets status
     * @param \Rancher\Model\ProjectNetworkPolicyStatus $status
     * @return $this
     */
