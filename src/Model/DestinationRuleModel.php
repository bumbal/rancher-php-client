...
class DestinationRuleModel implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        ...
        'subsets' => '\Rancher\Model\SubsetModel[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['subsets'] = isset($data['subsets']) ? $data['subsets'] : null;
    ...
    /**
     * Gets subsets
     * @return \Rancher\Model\SubsetModel[]
     */
    public function getSubsets()
    {
        return $this->container['subsets'];
    }

    /**
     * Sets subsets
     * @param \Rancher\Model\SubsetModel[] $subsets
     * @return $this
     */
    public function setSubsets($subsets)
    {
        $this->container['subsets'] = $subsets;
