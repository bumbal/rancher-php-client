...
class DaemonSetStatus implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        'collisionCount' => 'int',
        'conditions' => '\Rancher\Model\DaemonSetCondition[]',
    ...
    /**
     * Gets conditions
     * @return \Rancher\Model\DaemonSetCondition[]
     */
    ...
    /**
     * Sets conditions
     * @param \Rancher\Model\DaemonSetCondition[] $conditions
     * @return $this
     */
