...
class SupplementalGroupsStrategyOptions implements ArrayAccess
{
    protected $container = [];

    protected static $typeMap = [
        'ranges' => '\Rancher\Model\IdRange[]',
        'rule' => 'string',
    ];
    ...
    /**
     * Sets ranges
     * @param \Rancher\Model\IdRange[] $ranges
     * @return $this
     */
