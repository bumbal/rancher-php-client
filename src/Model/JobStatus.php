...
class JobStatus implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'conditions' => '\Rancher\Model\JobCondition[]',
        'failed' => 'int',
        'startTime' => '\DateTime',
        'succeeded' => 'int',
    ];
    ...
    /**
     * Gets conditions
     * @return \Rancher\Model\JobCondition[]
     */
    ...
    /**
     * Sets conditions
     * @param \Rancher\Model\JobCondition[] $conditions
     * @return $this
     */
