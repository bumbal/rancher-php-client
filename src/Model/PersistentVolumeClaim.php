...
class PersistentVolumeClaim implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'created' => '\DateTime',
        'creatorId' => 'string',
        'dataSource' => '\Rancher\Model\TypedLocalObjectReference',
        'labels' => 'map[string]',
        'name' => 'string',
        'namespaceId' => 'string',
        ...
        'state' => 'string',
        'status' => '\Rancher\Model\PersistentVolumeClaimStatus',
    ...
    /**
     * Gets dataSource
     * @return \Rancher\Model\TypedLocalObjectReference
     */
    ...
    /**
     * Sets dataSource
     * @param \Rancher\Model\TypedLocalObjectReference $dataSource
     * @return $this
     */
    ...
    /**
     * Gets status
     * @return \Rancher\Model\PersistentVolumeClaimStatus
     */
    ...
    /**
     * Sets status
     * @param \Rancher\Model\PersistentVolumeClaimStatus $status
     * @return $this
     */
