...
class Scheduling implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        'node' => '\Rancher\Model\NodeScheduling',
        'priority' => 'int',
        'priorityClassName' => 'string',
        'scheduler' => 'string',
        'tolerate' => '\Rancher\Model\Toleration[]',
    ];
    ...
    /**
     * Gets node
     * @return \Rancher\Model\NodeScheduling
     */
    ...
    /**
     * Sets node
     * @param \Rancher\Model\NodeScheduling $node
     * @return $this
     */
    ...
    /**
     * Sets tolerate
     * @param \Rancher\Model\Toleration[] $tolerate
     * @return $this
     */
