...
class DownwardAPIVolumeSource implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        'defaultMode' => 'int',
        'items' => '\Rancher\Model\DownwardAPIVolumeFile[]',
    ];
    ...
    /**
     * Gets items
     * @return \Rancher\Model\DownwardAPIVolumeFile[]
     */
    ...
    /**
     * Sets items
     * @param \Rancher\Model\DownwardAPIVolumeFile[] $items
     * @return $this
     */
