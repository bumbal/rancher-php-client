...
class DynamicSchemaModel implements ArrayAccess
{
    ...
    protected static $typeMap = [
        ...
        'collectionActions' => 'map[string,\Rancher\Model\ActionModel]',
        'collectionFields' => 'map[string,\Rancher\Model\FieldModel]',
        'collectionFilters' => 'map[string,\Rancher\Model\FilterModel]',
        ...
        'pluralName' => 'string',
        'removed' => '\DateTime',
        'resourceActions' => 'map[string,\Rancher\Model\ActionModel]',
        'resourceFields' => 'map[string,\Rancher\Model\FieldModel]',
