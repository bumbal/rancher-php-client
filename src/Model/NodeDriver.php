...
class NodeDriver implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'removed' => '\DateTime',
        'state' => 'string',
        'status' => '\Rancher\Model\NodeDriverStatus',
    ...
    /**
     * Gets status
     * @return \Rancher\Model\NodeDriverStatus
     */
    ...
    /**
     * Sets status
     * @param \Rancher\Model\NodeDriverStatus $status
     * @return $this
     */
