...
class NodeAffinity implements ArrayAccess
{
    protected $container = [];

    protected static $typeMap = [
        'preferredDuringSchedulingIgnoredDuringExecution' => '\Rancher\Model\PreferredSchedulingTerm[]',
        'requiredDuringSchedulingIgnoredDuringExecution' => '\Rancher\Model\NodeSelector',
    ];
     ...
     * @return \Rancher\Model\PreferredSchedulingTerm[]
     */
     ...
     * @param \Rancher\Model\PreferredSchedulingTerm[] $preferredDuringSchedulingIgnoredDuringExecution
     * @return $this
     */
     ...
     * @return \Rancher\Model\NodeSelector
     */
     ...
     * @param \Rancher\Model\NodeSelector $requiredDuringSchedulingIgnoredDuringExecution
     * @return $this
     */
