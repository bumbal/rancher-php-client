...
class AuthnConfig implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        'sans' => 'string[]',
        'strategy' => 'string',
        'webhook' => '\Rancher\Model\AuthWebhookConfig',
    ];
    ...
    /**
     * Gets webhook
     * @return \Rancher\Model\AuthWebhookConfig
     */
    ...
    /**
     * Sets webhook
     * @param \Rancher\Model\AuthWebhookConfig $webhook
     * @return $this
     */
