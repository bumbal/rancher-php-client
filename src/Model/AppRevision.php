...
class AppRevision implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'removed' => '\DateTime',
        'state' => 'string',
        'status' => '\Rancher\Model\AppRevisionStatus',
    ...
    /**
     * Gets status
     * @return \Rancher\Model\AppRevisionStatus
     */
    ...
    /**
     * Sets status
     * @param \Rancher\Model\AppRevisionStatus $status
     * @return $this
     */
