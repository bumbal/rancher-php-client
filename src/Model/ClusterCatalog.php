...
class ClusterCatalog implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'clusterId' => 'string',
        'commit' => 'string',
        'conditions' => '\Rancher\Model\CatalogCondition[]',
        'created' => '\DateTime',
        'creatorId' => 'string',
        'description' => 'string',
        'kind' => 'string',
    ...
    /**
     * Gets conditions
     * @return \Rancher\Model\CatalogCondition[]
     */
    ...
    /**
     * Sets conditions
     * @param \Rancher\Model\CatalogCondition[] $conditions
     * @return $this
     */
