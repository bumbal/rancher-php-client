...
class PersistentVolumeClaimStatus implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        'accessModes' => 'string[]',
        'capacity' => 'map[string]',
        'conditions' => '\Rancher\Model\PersistentVolumeClaimCondition[]',
        'phase' => 'string',
    ];
    ...
    /**
     * Gets conditions
     * @return \Rancher\Model\PersistentVolumeClaimCondition[]
     */
    ...
    /**
     * Sets conditions
     * @param \Rancher\Model\PersistentVolumeClaimCondition[] $conditions
     * @return $this
     */
