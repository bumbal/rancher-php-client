...
class DynamicSchema implements ArrayAccess
{
    protected $container = [];

    protected static $typeMap = [
        'annotations' => 'map[string]',
        'collectionActions' => 'map[\Rancher\Model\Action]',
        'collectionFields' => 'map[\Rancher\Model\Field]',
        'collectionFilters' => 'map[\Rancher\Model\Filter]',
        ...
        'pluralName' => 'string',
        'removed' => '\DateTime',
        'resourceActions' => 'map[\Rancher\Model\Action]',
        'resourceFields' => 'map[\Rancher\Model\Field]',
        'resourceMethods' => 'string[]',
        'schemaName' => 'string',
        'state' => 'string',
        'status' => '\Rancher\Model\DynamicSchemaStatus',
     ...
     * @param \Rancher\Model\Action[] $collectionActions
     * @return $this
     */
     ...
     * @param \Rancher\Model\Field[] $collectionFields
     * @return $this
     */
     ...
     * @param \Rancher\Model\Filter[] $collectionFilters
     * @return $this
     */
     ...
     * @param \Rancher\Model\Action[] $resourceActions
     * @return $this
     */
    ...
    /**
     * Sets resourceFields
     * @param \Rancher\Model\Field[] $resourceFields
     * @return $this
     */
    ...
    /**
     * Gets status
     * @return \Rancher\Model\DynamicSchemaStatus
     */
    ...
    /**
     * Sets status
     * @param \Rancher\Model\DynamicSchemaStatus $status
     * @return $this
     */
