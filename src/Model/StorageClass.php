...
class StorageClass implements ArrayAccess
{
    protected $container = [];

    protected static $typeMap = [
        'allowVolumeExpansion' => 'boolean',
        'allowedTopologies' => '\Rancher\Model\TopologySelectorTerm[]',
     ...
     * @return \Rancher\Model\TopologySelectorTerm[]
     */
     ...
     * @param \Rancher\Model\TopologySelectorTerm[] $allowedTopologies
     * @return $this
     */
