...
class BackupConfig implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'intervalHours' => 'int',
        'retention' => 'int',
        's3BackupConfig' => '\Rancher\Model\S3BackupConfig',
    ];
    ...
    /**
     * Gets s3BackupConfig
     * @return \Rancher\Model\S3BackupConfig
     */
    ...
    /**
     * Sets s3BackupConfig
     * @param \Rancher\Model\S3BackupConfig $s3BackupConfig
     * @return $this
     */
