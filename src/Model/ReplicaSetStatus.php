...
class ReplicaSetStatus implements ArrayAccess
{
    protected $container = [];

    protected static $typeMap = [
        'availableReplicas' => 'int',
        'conditions' => '\Rancher\Model\ReplicaSetCondition[]',
    ...
    /**
     * Gets conditions
     * @return \Rancher\Model\ReplicaSetCondition[]
     */
    ...
    /**
     * Sets conditions
     * @param \Rancher\Model\ReplicaSetCondition[] $conditions
     * @return $this
     */
