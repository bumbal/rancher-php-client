...
class ConfigMap implements ArrayAccess
{
    ...
    protected static $typeMap = [
        ...
        'binaryData' => 'map[\Rancher\Model\Base64]',
        'created' => '\DateTime',
        'creatorId' => 'string',
        'data' => 'map[string]',
        'labels' => 'map[string]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['binaryData'] = isset($data['binaryData']) ? $data['binaryData'] : null;
    ...
    {
        return $this->container['binaryData'];
    }

    /**
     * Sets binaryData
     * @param \Rancher\Model\Base64[] $binaryData
     * @return $this
     */
    public function setBinaryData($binaryData)
    {
        $this->container['binaryData'] = $binaryData;
