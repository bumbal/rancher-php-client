...
class ActiveDirectoryTestAndApplyInput implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        'activeDirectoryConfig' => '\Rancher\Model\ActiveDirectoryConfig',
        'enabled' => 'boolean',
        'password' => 'string',
        'username' => 'string',
    ];
     ...
     * @param \Rancher\Model\ActiveDirectoryConfig $activeDirectoryConfig
     * @return $this
     */
