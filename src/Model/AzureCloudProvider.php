...
class AzureCloudProvider implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        'aadClientCertPassword' => '\Rancher\Model\Password',
        'aadClientCertPath' => 'string',
        'aadClientId' => 'string',
        'aadClientSecret' => '\Rancher\Model\Password',
        'cloud' => 'string',
     ...
     * @param \Rancher\Model\Password $aadClientCertPassword
     * @return $this
     */
     ...
     * @param \Rancher\Model\Password $aadClientSecret
     * @return $this
     */
