...
class EnvVarModel implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        'name' => 'string',
        'value' => 'string',
        'valueFrom' => '\Rancher\Model\EnvVarSourceModel',
    ];
    ...
    /**
     * Gets valueFrom
     * @return \Rancher\Model\EnvVarSourceModel
     */
    ...
    /**
     * Sets valueFrom
     * @param \Rancher\Model\EnvVarSourceModel $valueFrom
     * @return $this
     */
