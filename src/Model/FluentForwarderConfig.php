...
class FluentForwarderConfig implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'compress' => 'boolean',
        'enableTls' => 'boolean',
        'fluentServers' => '\Rancher\Model\FluentServer[]',
    ];
    ...
    /**
     * Gets fluentServers
     * @return \Rancher\Model\FluentServer[]
     */
    ...
    /**
     * Sets fluentServers
     * @param \Rancher\Model\FluentServer[] $fluentServers
     * @return $this
     */
