...
class SourceCodeRepository implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        ...
        'permissions' => '\Rancher\Model\RepoPerm',
        'projectId' => 'string',
        'removed' => '\DateTime',
        'sourceCodeCredentialId' => 'string',
        'sourceCodeType' => 'string',
        'state' => 'string',
        'status' => '\Rancher\Model\SourceCodeRepositoryStatus',
    ...
    /**
     * Sets permissions
     * @param \Rancher\Model\RepoPerm $permissions
     * @return $this
     */
    ...
    /**
     * Gets status
     * @return \Rancher\Model\SourceCodeRepositoryStatus
     */
    ...
    /**
     * Sets status
     * @param \Rancher\Model\SourceCodeRepositoryStatus $status
     * @return $this
     */
