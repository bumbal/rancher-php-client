...
class ClusterSpec implements ArrayAccess
{
    protected $container = [];

    protected static $typeMap = [
        'amazonElasticContainerServiceConfig' => 'map[\Rancher\Model\Json]',
        'azureKubernetesServiceConfig' => 'map[\Rancher\Model\Json]',
        ...
        'genericEngineConfig' => 'map[\Rancher\Model\Json]',
        'googleKubernetesEngineConfig' => 'map[\Rancher\Model\Json]',
     ...
     * @param \Rancher\Model\Json[] $amazonElasticContainerServiceConfig
     * @return $this
     */
     ...
     * @param \Rancher\Model\Json[] $azureKubernetesServiceConfig
     * @return $this
     */
     ...
     * @param \Rancher\Model\Json[] $genericEngineConfig
     * @return $this
     */
     ...
     * @param \Rancher\Model\Json[] $googleKubernetesEngineConfig
     * @return $this
     */
