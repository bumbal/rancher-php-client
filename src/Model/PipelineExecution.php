...
class PipelineExecution implements ArrayAccess
{
    /**
    ...
    protected static $typeMap = [
        ...
        'branch' => 'string',
        'commit' => 'string',
        'conditions' => '\Rancher\Model\PipelineCondition[]',
        'created' => '\DateTime',
        'creatorId' => 'string',
        'email' => 'string',
        'ended' => 'string',
        ...
        'pipelineConfig' => '\Rancher\Model\PipelineConfig',
        'pipelineId' => 'string',
        'projectId' => 'string',
        'ref' => 'string',
        'removed' => '\DateTime',
        ...
        'run' => 'int',
        'stages' => '\Rancher\Model\StageStatus[]',
        'started' => 'string',
        'state' => 'string',
        'title' => 'string',
    ...
    /**
     * Gets conditions
     * @return \Rancher\Model\PipelineCondition[]
     */
    ...
    /**
     * Sets conditions
     * @param \Rancher\Model\PipelineCondition[] $conditions
     * @return $this
     */
    ...
    /**
     * Sets pipelineConfig
     * @param \Rancher\Model\PipelineConfig $pipelineConfig
     * @return $this
     */
    ...
    /**
     * Gets stages
     * @return \Rancher\Model\StageStatus[]
     */
    ...
    /**
     * Sets stages
     * @param \Rancher\Model\StageStatus[] $stages
     * @return $this
     */
