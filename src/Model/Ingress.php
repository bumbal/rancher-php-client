...
class Ingress implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'created' => '\DateTime',
        'creatorId' => 'string',
        'defaultBackend' => '\Rancher\Model\IngressBackend',
        'description' => 'string',
        'labels' => 'map[string]',
        'name' => 'string',
        'namespaceId' => 'string',
        ...
        'removed' => '\DateTime',
        'rules' => '\Rancher\Model\IngressRule[]',
        'state' => 'string',
        'status' => '\Rancher\Model\IngressStatus',
        'tls' => '\Rancher\Model\IngressTLS[]',
    ...
    /**
     * Gets defaultBackend
     * @return \Rancher\Model\IngressBackend
     */
    ...
    /**
     * Sets defaultBackend
     * @param \Rancher\Model\IngressBackend $defaultBackend
     * @return $this
     */
    ...
    /**
     * Gets rules
     * @return \Rancher\Model\IngressRule[]
     */
    ...
    /**
     * Sets rules
     * @param \Rancher\Model\IngressRule[] $rules
     * @return $this
     */
    ...
    /**
     * Gets status
     * @return \Rancher\Model\IngressStatus
     */
    ...
    /**
     * Sets status
     * @param \Rancher\Model\IngressStatus $status
     * @return $this
     */
    ...
    /**
     * Gets tls
     * @return \Rancher\Model\IngressTLS[]
     */
    ...
    /**
     * Sets tls
     * @param \Rancher\Model\IngressTLS[] $tls
     * @return $this
     */
