...
class NamespacedDockerCredential implements ArrayAccess
{
    protected $container = [];
    ...
    protected static $typeMap = [
        ...
        'projectId' => 'string',
        'registries' => 'map[\Rancher\Model\RegistryCredential]',
        'removed' => '\DateTime',
        'uuid' => 'string',
    ];
    ...
    /**
     * Gets registries
     * @return \Rancher\Model\RegistryCredential[]
     */
    ...
    /**
     * Sets registries
     * @param \Rancher\Model\RegistryCredential[] $registries
     * @return $this
     */
