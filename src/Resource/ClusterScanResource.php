...
class ClusterScanResource
{
     ...
     * @var string
     */
    protected $resourceName = 'clusterScan/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'clusterScans/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterScanModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ClusterScanModel');
    }
