...
class NamespacedDockerCredential
{
    /**
     * @var RancherClient
     */
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\NamespacedDockerCredential
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespacedDockerCredential');
    }
