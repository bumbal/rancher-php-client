...
class ComposeConfigResource
{
     ...
     * @var string
     */
    protected $resourceName = 'composeConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'composeConfigs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ComposeConfigModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ComposeConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ComposeConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ComposeConfigModel
     */
