...
class SecretResource
{
     ...
     * @var string
     */
    protected $resourceName = 'secret/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'secrets/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\SecretModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\SecretModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\SecretModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\SecretModel
     */
