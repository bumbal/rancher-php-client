...
class SettingResource
{
     ...
     * @var string
     */
    protected $resourcePluralName = 'settings/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\SettingModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\SettingModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\SettingModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\SettingModel
     */
