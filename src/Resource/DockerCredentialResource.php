...
class DockerCredentialResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'dockerCredential/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'dockerCredentials/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\DockerCredentialModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\DockerCredentialModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\DockerCredentialModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\DockerCredentialModel
     */
