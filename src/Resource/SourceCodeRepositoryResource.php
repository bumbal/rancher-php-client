...
class SourceCodeRepositoryResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'sourceCodeRepository/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'sourceCodeRepositories/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\SourceCodeRepositoryModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\SourceCodeRepositoryModel');
    }
