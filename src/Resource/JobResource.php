...
class JobResource
{
     ...
     * @var string
     */
    protected $resourcePluralName = 'jobs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\JobModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\JobModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\JobModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\JobModel
     */
