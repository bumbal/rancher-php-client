...
class GatewayResource
{
     ...
     * @var string
     */
    protected $resourceName = 'gateway/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'gateways/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\GatewayModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GatewayModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\GatewayModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\GatewayModel
     */
