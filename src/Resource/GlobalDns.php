...
class GlobalDns
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\GlobalDns
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GlobalDns');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\UpdateGlobalDNSTargetsInput $input
     *
     * @throws \Exception
     * @return void
     */
