...
class NamespacedCertificateResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'namespacedCertificate/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'namespacedCertificates/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedCertificateModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespacedCertificateModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\NamespacedCertificateModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedCertificateModel
     */
