...
class NodePoolResource
{
     ...
     * @var string
     */
    protected $resourceName = 'nodePool/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'nodePools/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NodePoolModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NodePoolModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\NodePoolModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NodePoolModel
     */
