...
class ListenConfig
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\ListenConfig
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ListenConfig');
    }

    /**
     * set
     *
     * @param \Rancher\Model\ListenConfig $data
     *
     * @throws \Exception
     * @return \Rancher\Model\ListenConfig
     */
