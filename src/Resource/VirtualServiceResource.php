...
class VirtualServiceResource
{
     ...
     * @var string
     */
    protected $resourceName = 'virtualService/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'virtualServices/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\VirtualServiceModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\VirtualServiceModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\VirtualServiceModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\VirtualServiceModel
     */
