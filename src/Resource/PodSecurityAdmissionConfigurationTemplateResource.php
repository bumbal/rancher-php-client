...
/**
 * PodSecurityAdmissionConfigurationTemplateResource
 *
 * @category Class
 * @package  Rancher
...
class PodSecurityAdmissionConfigurationTemplateResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'podSecurityAdmissionConfigurationTemplate/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'podSecurityAdmissionConfigurationTemplates/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\PodSecurityAdmissionConfigurationTemplateModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PodSecurityAdmissionConfigurationTemplateModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\PodSecurityAdmissionConfigurationTemplateModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\PodSecurityAdmissionConfigurationTemplateModel
     */
