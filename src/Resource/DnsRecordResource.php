...
class DnsRecordResource
{
     ...
     * @var string
     */
    protected $resourceName = 'dnsRecord/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'dnsRecords/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\DnsRecordModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\DnsRecordModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\DnsRecordModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\DnsRecordModel
     */
