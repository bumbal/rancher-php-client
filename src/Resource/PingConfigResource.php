...
class PingConfigResource
{
     ...
     * @var string
     */
    protected $resourceName = 'pingConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'pingConfigs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\PingConfigModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PingConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\PingConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\PingConfigModel
     */
