...
/**
 * PodSecurityPolicyTemplateResource
 *
 * @category Class
 * @package  Rancher
...
class PodSecurityPolicyTemplateResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'podSecurityPolicyTemplate/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'podSecurityPolicyTemplates/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\PodSecurityPolicyTemplateModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PodSecurityPolicyTemplateModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\PodSecurityPolicyTemplateModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\PodSecurityPolicyTemplateModel
     */
