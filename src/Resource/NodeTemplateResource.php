...
class NodeTemplateResource
{
     ...
     * @var string
     */
    protected $resourceName = 'nodeTemplate/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'nodeTemplates/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NodeTemplateModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NodeTemplateModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\NodeTemplateModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NodeTemplateModel
     */
