...
class OpenLdapConfig
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\OpenLdapConfig
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\OpenLdapConfig');
    }

    /**
     * set
     *
     * @param \Rancher\Model\OpenLdapConfig $data
     *
     * @throws \Exception
     * @return \Rancher\Model\OpenLdapConfig
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\OpenLdapTestAndApplyInput $input
     *
     * @throws \Exception
     * @return void
     */
