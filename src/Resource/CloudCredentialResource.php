...
class CloudCredentialResource
{
     ...
     * @var string
     */
    protected $resourceName = 'cloudCredential/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'cloudCredentials/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\CloudCredentialModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\CloudCredentialModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\CloudCredentialModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\CloudCredentialModel
     */
