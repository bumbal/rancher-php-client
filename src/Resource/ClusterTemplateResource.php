...
class ClusterTemplateResource
{
     ...
     * @var string
     */
    protected $resourceName = 'clusterTemplate/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'clusterTemplates/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterTemplateModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ClusterTemplateModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ClusterTemplateModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterTemplateModel
     */
