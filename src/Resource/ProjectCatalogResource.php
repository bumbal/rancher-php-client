...
class ProjectCatalogResource
{
     ...
     * @var string
     */
    protected $resourceName = 'projectCatalog/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'projectCatalogs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectCatalogModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ProjectCatalogModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\ProjectCatalogModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectCatalogModel
     */
