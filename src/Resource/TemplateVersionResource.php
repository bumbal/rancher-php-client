...
class TemplateVersionResource
{
     ...
     * @var string
     */
    protected $resourceName = 'templateVersion/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'templateVersions/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\TemplateVersionModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\TemplateVersionModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\TemplateVersionModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\TemplateVersionModel
     */
