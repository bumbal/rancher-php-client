...
class Deployment
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\Deployment
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\Deployment');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\DeploymentRollbackInput $input
     *
     * @throws \Exception
     * @return void
     */
