...
class BitbucketCloudProvider
{
     ...
     * @var string
     */
    protected $resourceName = 'bitbucketCloudProvider/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'bitbucketCloudProviders/';
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\BitbucketCloudProvider
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\BitbucketCloudProvider');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\AuthUserInput $input
     *
     * @throws \Exception
