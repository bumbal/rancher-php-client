...
class ActiveDirectoryConfig
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\ActiveDirectoryConfig
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ActiveDirectoryConfig');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\ActiveDirectoryTestAndApplyInput $input
     *
     * @throws \Exception
     * @return void
     */
