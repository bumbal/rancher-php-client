...
/**
 * MultiClusterAppRevisionResource
 *
 * @category Class
 * @package  Rancher
...
class MultiClusterAppRevisionResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'multiClusterAppRevision/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'multiClusterAppRevisions/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\MultiClusterAppRevisionModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\MultiClusterAppRevisionModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\MultiClusterAppRevisionModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\MultiClusterAppRevisionModel
     */
