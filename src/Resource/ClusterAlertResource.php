...
class ClusterAlertResource
{
     ...
     * @var string
     */
    protected $resourceName = 'clusterAlert/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'clusterAlerts/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterAlertModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ClusterAlertModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ClusterAlertModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterAlertModel
     */
