...
class BasicAuthResource
{
     ...
     * @var string
     */
    protected $resourceName = 'basicAuth/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'basicAuths/';
    ...
    public function get($id)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\BasicAuthModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\BasicAuthModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\BasicAuthModel
     */
