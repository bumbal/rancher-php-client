...
class ActiveDirectoryConfigResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'activeDirectoryConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'activeDirectoryConfigs/';
    ...
    public function get($id)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ActiveDirectoryConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ActiveDirectoryConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ActiveDirectoryConfigModel
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\ActiveDirectoryTestAndApplyInputModel $input
     *
     * @throws RancherException
     * @return void
     */
