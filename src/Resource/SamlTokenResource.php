...
class SamlTokenResource
{
     ...
     * @var string
     */
    protected $resourceName = 'samlToken/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'samlTokens/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\SamlTokenModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\SamlTokenModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\SamlTokenModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\SamlTokenModel
     */
