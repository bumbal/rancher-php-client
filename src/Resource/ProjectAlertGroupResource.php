...
class ProjectAlertGroupResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'projectAlertGroup/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'projectAlertGroups/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectAlertGroupModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ProjectAlertGroupModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ProjectAlertGroupModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectAlertGroupModel
     */
