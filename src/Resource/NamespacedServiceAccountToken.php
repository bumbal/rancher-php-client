...
class NamespacedServiceAccountToken
{
    /**
     * @var RancherClient
     */
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\NamespacedServiceAccountToken
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespacedServiceAccountToken');
    }
