...
class FreeIpaConfigResource
{
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\FreeIpaConfigModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\FreeIpaConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\FreeIpaConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\FreeIpaConfigModel
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\FreeIpaTestAndApplyInputModel $input
     *
     * @throws RancherException
     * @return void
     */
