...
class DestinationRuleResource
{
     ...
     * @var string
     */
    protected $resourceName = 'destinationRule/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'destinationRules/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\DestinationRuleModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\DestinationRuleModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\DestinationRuleModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\DestinationRuleModel
     */
