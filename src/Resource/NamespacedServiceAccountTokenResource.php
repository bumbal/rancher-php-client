...
class NamespacedServiceAccountTokenResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'namespacedServiceAccountToken/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'namespacedServiceAccountTokens/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedServiceAccountTokenModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespacedServiceAccountTokenModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\NamespacedServiceAccountTokenModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedServiceAccountTokenModel
     */
