...
class AzureADConfig
{
     ...
     * @var string
     */
    protected $resourceName = 'azureADConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'azureADConfigs/';
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\AzureADConfig
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\AzureADConfig');
    }

    /**
     * set
     *
     * @param \Rancher\Model\AzureADConfig $data
     *
     * @throws \Exception
     * @return \Rancher\Model\AzureADConfig
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\AzureADConfig $input
     *
     * @throws \Exception
     * @return \Rancher\Model\AzureADConfigTestOutput
     */
    public function configureTest($id, $input)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\AzureADConfigTestOutput');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\AzureADConfigApplyInput $input
     *
     * @throws \Exception
     * @return void
     */
