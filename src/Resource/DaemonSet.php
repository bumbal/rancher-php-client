...
class DaemonSet
{
     ...
     * @var string
     */
    protected $resourceName = 'daemonSet/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'daemonSets/';
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\DaemonSet
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\DaemonSet');
    }

    /**
     * set
     *
     * @param \Rancher\Model\DaemonSet $data
     *
     * @throws \Exception
     * @return \Rancher\Model\DaemonSet
     */
