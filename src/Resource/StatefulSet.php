...
class StatefulSet
{
     ...
     * @var string
     */
    protected $resourceName = 'statefulSet/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'statefulSets/';
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\StatefulSet
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\StatefulSet');
    }

    /**
     * set
     *
     * @param \Rancher\Model\StatefulSet $data
     *
     * @throws \Exception
     * @return \Rancher\Model\StatefulSet
     */
