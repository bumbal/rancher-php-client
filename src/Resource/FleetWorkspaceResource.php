...
class FleetWorkspaceResource
{
     ...
     * @var string
     */
    protected $resourceName = 'fleetWorkspace/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'fleetWorkspaces/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\FleetWorkspaceModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\FleetWorkspaceModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\FleetWorkspaceModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\FleetWorkspaceModel
     */
