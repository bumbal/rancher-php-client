...
class GithubConfig
{
    ...
    public function get($id)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GithubConfig');
    }

    /**
     * set
     *
     * @param \Rancher\Model\GithubConfig $data
     *
     * @throws \Exception
     * @return \Rancher\Model\GithubConfig
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\GithubConfig $input
     *
     * @throws \Exception
     * @return \Rancher\Model\GithubConfigTestOutput
     */
    public function configureTest($id, $input)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GithubConfigTestOutput');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\GithubConfigApplyInput $input
     *
     * @throws \Exception
     * @return void
     */
