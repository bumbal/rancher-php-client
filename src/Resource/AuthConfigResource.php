...
class AuthConfigResource
{
     ...
     * @var string
     */
    protected $resourceName = 'authConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'authConfigs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\AuthConfigModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\AuthConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\AuthConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\AuthConfigModel
     */
