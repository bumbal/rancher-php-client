...
class ProjectLoggingResource
{
     ...
     * @var string
     */
    protected $resourceName = 'projectLogging/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'projectLoggings/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectLoggingModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ProjectLoggingModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ProjectLoggingModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectLoggingModel
     */
