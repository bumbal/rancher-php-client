...
class ServiceAccountTokenResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'serviceAccountToken/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'serviceAccountTokens/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ServiceAccountTokenModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ServiceAccountTokenModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ServiceAccountTokenModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ServiceAccountTokenModel
     */
