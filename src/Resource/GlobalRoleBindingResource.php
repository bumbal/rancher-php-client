...
class GlobalRoleBindingResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'globalRoleBinding/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'globalRoleBindings/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\GlobalRoleBindingModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GlobalRoleBindingModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\GlobalRoleBindingModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\GlobalRoleBindingModel
     */
