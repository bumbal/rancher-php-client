...
class CronJobResource
{
     ...
     * @var string
     */
    protected $resourceName = 'cronJob/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'cronJobs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\CronJobModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\CronJobModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\CronJobModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\CronJobModel
     */
