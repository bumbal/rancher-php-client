...
class NamespacedSecretResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'namespacedSecret/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'namespacedSecrets/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedSecretModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespacedSecretModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\NamespacedSecretModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedSecretModel
     */
