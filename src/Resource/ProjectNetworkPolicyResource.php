...
class ProjectNetworkPolicyResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'projectNetworkPolicy/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'projectNetworkPolicies/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectNetworkPolicyModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ProjectNetworkPolicyModel');
    }
