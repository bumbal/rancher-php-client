...
class GroupMemberResource
{
     ...
     * @var string
     */
    protected $resourceName = 'groupMember/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'groupMembers/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\GroupMemberModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GroupMemberModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\GroupMemberModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\GroupMemberModel
     */
