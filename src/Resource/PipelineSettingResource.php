...
class PipelineSettingResource
{
     ...
     * @var string
     */
    protected $resourceName = 'pipelineSetting/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'pipelineSettings/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\PipelineSettingModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PipelineSettingModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\PipelineSettingModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\PipelineSettingModel
     */
