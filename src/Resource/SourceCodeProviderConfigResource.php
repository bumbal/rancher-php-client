...
/**
 * SourceCodeProviderConfigResource
 *
 * @category Class
 * @package  Rancher
...
class SourceCodeProviderConfigResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'sourceCodeProviderConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'sourceCodeProviderConfigs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\SourceCodeProviderConfigModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\SourceCodeProviderConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\SourceCodeProviderConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\SourceCodeProviderConfigModel
     */
