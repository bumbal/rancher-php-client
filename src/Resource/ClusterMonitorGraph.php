...
class ClusterMonitorGraph
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\ClusterMonitorGraph
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ClusterMonitorGraph');
    }

    /**
     * set
     *
     * @param \Rancher\Model\ClusterMonitorGraph $data
     *
     * @throws \Exception
     * @return \Rancher\Model\ClusterMonitorGraph
     */
