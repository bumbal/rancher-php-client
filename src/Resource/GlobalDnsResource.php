...
class GlobalDnsResource
{
     ...
     * @var string
     */
    protected $resourceName = 'globalDns/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'globalDnses/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\GlobalDnsModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GlobalDnsModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\GlobalDnsModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\GlobalDnsModel
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\UpdateGlobalDNSTargetsInputModel $input
     *
     * @throws RancherException
     * @return void
     */
