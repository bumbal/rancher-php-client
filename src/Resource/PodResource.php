...
class PodResource
{
     ...
     * @var string
     */
    protected $resourceName = 'pod/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'pods/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\PodModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PodModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\PodModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\PodModel
     */
