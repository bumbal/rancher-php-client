...
class RkeAddonResource
{
     ...
     * @var string
     */
    protected $resourceName = 'rkeAddon/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'rkeAddons/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\RkeAddonModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\RkeAddonModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\RkeAddonModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\RkeAddonModel
     */
