...
class ClusterAlertGroupResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'clusterAlertGroup/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'clusterAlertGroups/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterAlertGroupModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ClusterAlertGroupModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ClusterAlertGroupModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterAlertGroupModel
     */
