...
class NamespacedSshAuthResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'namespacedSshAuth/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'namespacedSshAuths/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedSshAuthModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespacedSshAuthModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\NamespacedSshAuthModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedSshAuthModel
     */
