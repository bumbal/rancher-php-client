...
class SshAuthResource
{
     ...
     * @var string
     */
    protected $resourceName = 'sshAuth/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'sshAuths/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\SshAuthModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\SshAuthModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\SshAuthModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\SshAuthModel
     */
