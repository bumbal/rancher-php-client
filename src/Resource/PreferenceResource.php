...
class PreferenceResource
{
     ...
     * @var string
     */
    protected $resourceName = 'preference/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'preferences/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\PreferenceModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PreferenceModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\PreferenceModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\PreferenceModel
     */
