...
class AppResource
{
     ...
     * @var string
     */
    protected $resourceName = 'app/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'apps/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\AppModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\AppModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\AppModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\AppModel
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\RollbackRevisionModel $input
     *
     * @throws RancherException
     * @return void
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\AppUpgradeConfigModel $input
     *
     * @throws RancherException
     * @return void
     */
    public function upgrade($id, $input)
    {
        $postData = (array) \Rancher\ObjectSerializer::sanitizeForSerialization($input);

        $this->client->request('POST', $this->constructPath() . $id . '?action=upgrade', $postData);
