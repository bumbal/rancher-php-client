...
class AdfsConfigResource
{
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\AdfsConfigModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\AdfsConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\AdfsConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\AdfsConfigModel
     */
