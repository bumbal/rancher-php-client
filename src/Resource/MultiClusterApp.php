...
class MultiClusterApp
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\MultiClusterApp
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\MultiClusterApp');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\UpdateMultiClusterAppTargetsInput $input
     *
     * @throws \Exception
     * @return void
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\MultiClusterAppRollbackInput $input
     *
     * @throws \Exception
     * @return void
     */
