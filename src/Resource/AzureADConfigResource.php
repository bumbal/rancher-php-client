...
class AzureADConfigResource
{
     ...
     *
     * @param string $id
     * @param \Rancher\Model\AzureADConfigModel $input
     *
     * @throws RancherException
     * @return \Rancher\Model\AzureADConfigTestOutputModel
     */
    public function configureTest($id, $input)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\AzureADConfigTestOutputModel');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\AzureADConfigApplyInputModel $input
     *
     * @throws RancherException
     * @return void
     */
