...
class ClusterLoggingResource
{
     ...
     * @var string
     */
    protected $resourceName = 'clusterLogging/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'clusterLoggings/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterLoggingModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ClusterLoggingModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ClusterLoggingModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterLoggingModel
     */
