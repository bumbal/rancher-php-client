...
class ProjectMonitorGraphResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'projectMonitorGraph/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'projectMonitorGraphs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectMonitorGraphModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ProjectMonitorGraphModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\ProjectMonitorGraphModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectMonitorGraphModel
     */
