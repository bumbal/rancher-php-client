...
class PrometheusResource
{
     ...
     * @var string
     */
    protected $resourceName = 'prometheus/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'prometheuses/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\PrometheusModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PrometheusModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\PrometheusModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\PrometheusModel
     */
