...
class BitbucketCloudPipelineConfig
{
    /**
     * @var RancherClient
     */
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\BitbucketCloudPipelineConfig
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\BitbucketCloudPipelineConfig');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\BitbucketCloudApplyInput $input
     *
     * @throws \Exception
     * @return void
     */
