...
class GlobalRole
{
     ...
     * @var string
     */
    protected $resourceName = 'globalRole/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'globalRoles/';
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\GlobalRole
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GlobalRole');
    }

    /**
     * set
     *
     * @param \Rancher\Model\GlobalRole $data
     *
     * @throws \Exception
     * @return \Rancher\Model\GlobalRole
     */
