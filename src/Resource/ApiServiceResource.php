...
class ApiServiceResource
{
     ...
     * @var string
     */
    protected $resourceName = 'apiService/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'apiServices/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ApiServiceModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ApiServiceModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ApiServiceModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ApiServiceModel
     */
