...
class AlertmanagerResource
{
     ...
     * @var string
     */
    protected $resourceName = 'alertmanager/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'alertmanagers/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\AlertmanagerModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\AlertmanagerModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\AlertmanagerModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\AlertmanagerModel
     */
