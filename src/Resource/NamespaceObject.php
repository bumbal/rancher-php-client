...
class NamespaceObject
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\NamespaceObject
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespaceObject');
    }

    /**
     * set
     *
     * @param \Rancher\Model\NamespaceObject $data
     *
     * @throws \Exception
     * @return \Rancher\Model\NamespaceObject
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\NamespaceMove $input
     *
     * @throws \Exception
     * @return void
     */
