...
class KontainerDriverResource
{
     ...
     * @var string
     */
    protected $resourceName = 'kontainerDriver/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'kontainerDrivers/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\KontainerDriverModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\KontainerDriverModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\KontainerDriverModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\KontainerDriverModel
     */
