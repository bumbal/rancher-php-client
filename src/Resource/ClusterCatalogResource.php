...
class ClusterCatalogResource
{
     ...
     * @var string
     */
    protected $resourceName = 'clusterCatalog/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'clusterCatalogs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterCatalogModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ClusterCatalogModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\ClusterCatalogModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterCatalogModel
     */
