...
class StorageClassResource
{
     ...
     * @var string
     */
    protected $resourceName = 'storageClass/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'storageClasses/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\StorageClassModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\StorageClassModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\StorageClassModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\StorageClassModel
     */
