...
class ManagementSecretResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'managementSecret/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'managementSecrets/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ManagementSecretModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ManagementSecretModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ManagementSecretModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ManagementSecretModel
     */
