...
class IngressResource
{
     ...
     * @var string
     */
    protected $resourceName = 'ingress/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'ingresses/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\IngressModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\IngressModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\IngressModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\IngressModel
     */
