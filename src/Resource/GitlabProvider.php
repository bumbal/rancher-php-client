...
class GitlabProvider
{
     ...
     * @var string
     */
    protected $resourceName = 'gitlabProvider/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'gitlabProviders/';
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\GitlabProvider
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GitlabProvider');
    }
