...
class TemplateContentResource
{
     ...
     * @var string
     */
    protected $resourceName = 'templateContent/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'templateContents/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\TemplateContentModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\TemplateContentModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\TemplateContentModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\TemplateContentModel
     */
