...
class ProjectAlertResource
{
     ...
     * @var string
     */
    protected $resourceName = 'projectAlert/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'projectAlerts/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectAlertModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ProjectAlertModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ProjectAlertModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectAlertModel
     */
