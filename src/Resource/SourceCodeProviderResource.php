...
class SourceCodeProviderResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'sourceCodeProvider/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'sourceCodeProviders/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\SourceCodeProviderModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\SourceCodeProviderModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\SourceCodeProviderModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\SourceCodeProviderModel
     */
