...
class ReplicationControllerResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'replicationController/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'replicationControllers/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ReplicationControllerModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ReplicationControllerModel');
    }
