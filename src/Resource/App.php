...
class App
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\App
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\App');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\RollbackRevision $input
     *
     * @throws \Exception
     * @return void
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\AppUpgradeConfig $input
     *
     * @throws \Exception
     * @return void
     */
