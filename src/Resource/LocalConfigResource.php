...
class LocalConfigResource
{
     ...
     * @var string
     */
    protected $resourceName = 'localConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'localConfigs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\LocalConfigModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\LocalConfigModel');
    }
