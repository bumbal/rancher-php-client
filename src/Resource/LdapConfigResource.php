...
class LdapConfigResource
{
     ...
     * @var string
     */
    protected $resourceName = 'ldapConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'ldapConfigs/';
    ...
    public function get($id)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\LdapConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\LdapConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\LdapConfigModel
     */
