...
class CisConfigResource
{
     ...
     * @var string
     */
    protected $resourceName = 'cisConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'cisConfigs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\CisConfigModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\CisConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\CisConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\CisConfigModel
     */
