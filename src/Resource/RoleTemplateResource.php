...
class RoleTemplateResource
{
     ...
     * @var string
     */
    protected $resourceName = 'roleTemplate/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'roleTemplates/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\RoleTemplateModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\RoleTemplateModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\RoleTemplateModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\RoleTemplateModel
     */
