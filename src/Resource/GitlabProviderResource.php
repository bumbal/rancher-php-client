...
class GitlabProviderResource
{
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\GitlabProviderModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GitlabProviderModel');
    }
