...
class NamespacedCertificate
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\NamespacedCertificate
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespacedCertificate');
    }
