...
class FeatureResource
{
     ...
     * @var string
     */
    protected $resourceName = 'feature/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'features/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\FeatureModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\FeatureModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\FeatureModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\FeatureModel
     */
