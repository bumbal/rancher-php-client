...
class AppRevision
{
     ...
     * @var string
     */
    protected $resourceName = 'appRevision/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'appRevisions/';
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\AppRevision
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\AppRevision');
    }

    /**
     * set
     *
     * @param \Rancher\Model\AppRevision $data
     *
     * @throws \Exception
     * @return \Rancher\Model\AppRevision
     */
