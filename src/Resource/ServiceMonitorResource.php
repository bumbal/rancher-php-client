...
class ServiceMonitorResource
{
     ...
     * @var string
     */
    protected $resourceName = 'serviceMonitor/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'serviceMonitors/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ServiceMonitorModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ServiceMonitorModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ServiceMonitorModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ServiceMonitorModel
     */
