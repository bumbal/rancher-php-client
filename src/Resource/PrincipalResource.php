...
class PrincipalResource
{
     ...
     * @var string
     */
    protected $resourceName = 'principal/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'principals/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\PrincipalModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PrincipalModel');
    }
