...
class PersistentVolumeResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'persistentVolume/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'persistentVolumes/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\PersistentVolumeModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PersistentVolumeModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\PersistentVolumeModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\PersistentVolumeModel
     */
