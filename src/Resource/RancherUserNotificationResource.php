...
/**
 * RancherUserNotificationResource
 *
 * @category Class
 * @package  Rancher
...
class RancherUserNotificationResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'rancherUserNotification/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'rancherUserNotifications/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\RancherUserNotificationModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\RancherUserNotificationModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\RancherUserNotificationModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\RancherUserNotificationModel
     */
