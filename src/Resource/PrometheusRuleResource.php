...
class PrometheusRuleResource
{
     ...
     * @var string
     */
    protected $resourceName = 'prometheusRule/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'prometheusRules/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\PrometheusRuleModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PrometheusRuleModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\PrometheusRuleModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\PrometheusRuleModel
     */
