...
/**
 * BitbucketCloudProviderResource
 *
 * @category Class
 * @package  Rancher
...
class BitbucketCloudProviderResource
{
    /**
     * @var RancherClient
     */
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\BitbucketCloudProviderModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\BitbucketCloudProviderModel');
    }
