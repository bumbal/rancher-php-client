...
class ProjectNetworkPolicy
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\ProjectNetworkPolicy
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ProjectNetworkPolicy');
    }
