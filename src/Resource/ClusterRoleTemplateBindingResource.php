...
/**
 * ClusterRoleTemplateBindingResource
 *
 * @category Class
 * @package  Rancher
...
class ClusterRoleTemplateBindingResource
{
    /**
     * @var RancherClient
     */
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterRoleTemplateBindingModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ClusterRoleTemplateBindingModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ClusterRoleTemplateBindingModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterRoleTemplateBindingModel
     */
