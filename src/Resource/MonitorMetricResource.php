...
class MonitorMetricResource
{
     ...
     * @var string
     */
    protected $resourceName = 'monitorMetric/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'monitorMetrics/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\MonitorMetricModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\MonitorMetricModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\MonitorMetricModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\MonitorMetricModel
     */
