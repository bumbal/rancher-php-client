...
class TemplateResource
{
     ...
     * @var string
     */
    protected $resourceName = 'template/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'templates/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\TemplateModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\TemplateModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\TemplateModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\TemplateModel
     */
