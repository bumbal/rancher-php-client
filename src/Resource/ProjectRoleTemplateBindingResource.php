...
/**
 * ProjectRoleTemplateBindingResource
 *
 * @category Class
 * @package  Rancher
...
class ProjectRoleTemplateBindingResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'projectRoleTemplateBinding/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'projectRoleTemplateBindings/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectRoleTemplateBindingModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ProjectRoleTemplateBindingModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ProjectRoleTemplateBindingModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ProjectRoleTemplateBindingModel
     */
