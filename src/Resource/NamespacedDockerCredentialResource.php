...
/**
 * NamespacedDockerCredentialResource
 *
 * @category Class
 * @package  Rancher
...
class NamespacedDockerCredentialResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'namespacedDockerCredential/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'namespacedDockerCredentials/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedDockerCredentialModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespacedDockerCredentialModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\NamespacedDockerCredentialModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedDockerCredentialModel
     */
