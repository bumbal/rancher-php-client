...
class ReplicaSetResource
{
     ...
     * @var string
     */
    protected $resourceName = 'replicaSet/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'replicaSets/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ReplicaSetModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ReplicaSetModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\ReplicaSetModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ReplicaSetModel
     */
