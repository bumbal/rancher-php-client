...
class GoogleOauthConfigResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'googleOauthConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'googleOauthConfigs/';
    ...
    public function get($id)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GoogleOauthConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\GoogleOauthConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\GoogleOauthConfigModel
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\GoogleOauthConfigModel $input
     *
     * @throws RancherException
     * @return \Rancher\Model\GoogleOauthConfigTestOutputModel
     */
    public function configureTest($id, $input)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GoogleOauthConfigTestOutputModel');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\GoogleOauthConfigApplyInputModel $input
     *
     * @throws RancherException
     * @return void
     */
