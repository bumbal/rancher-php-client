...
class CertificateResource
{
     ...
     * @var string
     */
    protected $resourceName = 'certificate/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'certificates/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\CertificateModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\CertificateModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\CertificateModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\CertificateModel
     */
