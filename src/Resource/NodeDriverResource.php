...
class NodeDriverResource
{
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NodeDriverModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NodeDriverModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\NodeDriverModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NodeDriverModel
     */
