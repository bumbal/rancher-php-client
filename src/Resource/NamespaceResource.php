...
class NamespaceResource
{
     ...
     * @var string
     */
    protected $path = '/v3/cluster/';

    /**
     * @var string
     */
    protected $resourceName = 'namespace/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'namespaces/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespaceModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespaceModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\NamespaceModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespaceModel
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\NamespaceMoveModel $input
     *
     * @throws RancherException
     * @return void
     */
    public function move($id, $input)
    {
        $postData = (array) \Rancher\ObjectSerializer::sanitizeForSerialization($input);

        $this->client->request('POST', $this->constructPath() . $id . '?action=move', $postData);
