...
class DynamicSchemaResource
{
     ...
     * @var string
     */
    protected $resourceName = 'dynamicSchema/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'dynamicSchemas/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\DynamicSchemaModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\DynamicSchemaModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\DynamicSchemaModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\DynamicSchemaModel
     */
