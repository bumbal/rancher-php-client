...
class NamespacedBasicAuth
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\NamespacedBasicAuth
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespacedBasicAuth');
    }
