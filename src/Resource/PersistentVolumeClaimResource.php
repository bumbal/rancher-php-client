...
class PersistentVolumeClaimResource
{
     ...
     * @var string
     */
    protected $resourceName = 'persistentVolumeClaim/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'persistentVolumeClaims/';
    ...
    public function get($id)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\PersistentVolumeClaimModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\PersistentVolumeClaimModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\PersistentVolumeClaimModel
     */
