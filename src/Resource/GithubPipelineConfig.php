...
class GithubPipelineConfig
{
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\GithubPipelineConfig
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\GithubPipelineConfig');
    }
     ...
     *
     * @param string $id
     * @param \Rancher\Model\GithubApplyInput $input
     *
     * @throws \Exception
     * @return void
     */
