...
class NotifierResource
{
     ...
     * @var string
     */
    protected $resourceName = 'notifier/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'notifiers/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NotifierModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NotifierModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\NotifierModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NotifierModel
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\NotificationModel $input
     *
     * @throws RancherException
     * @return void
     */
    public function send($id, $input)
    {
        $postData = (array) \Rancher\ObjectSerializer::sanitizeForSerialization($input);

        $this->client->request('POST', $this->constructPath() . $id . '?action=send', $postData);
