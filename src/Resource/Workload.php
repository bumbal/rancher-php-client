...
class Workload
{
     ...
     * @var string
     */
    protected $resourceName = 'workload/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'workloads/';
     ...
     *
     * @throws \Exception
     * @return \Rancher\Model\Workload
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\Workload');
    }

    /**
     * set
     *
     * @param \Rancher\Model\Workload $data
     *
     * @throws \Exception
     * @return \Rancher\Model\Workload
     */
