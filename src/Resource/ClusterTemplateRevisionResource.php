...
/**
 * ClusterTemplateRevisionResource
 *
 * @category Class
 * @package  Rancher
...
class ClusterTemplateRevisionResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'clusterTemplateRevision/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'clusterTemplateRevisions/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterTemplateRevisionModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ClusterTemplateRevisionModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ClusterTemplateRevisionModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterTemplateRevisionModel
     */
    ...
    {
        $this->client->request('POST', $this->constructPath() . $id . '?action=enable', []);
