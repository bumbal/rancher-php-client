...
class ShibbolethConfigResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'shibbolethConfig/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'shibbolethConfigs/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ShibbolethConfigModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ShibbolethConfigModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ShibbolethConfigModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ShibbolethConfigModel
     */
     ...
     *
     * @param string $id
     * @param \Rancher\Model\SamlConfigTestInputModel $input
     *
     * @throws RancherException
     * @return \Rancher\Model\SamlConfigTestOutputModel
     */
    public function testAndEnable($id, $input)
    {
        ...
        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\SamlConfigTestOutputModel');
    }
}
