...
class TokenResource
{
     ...
     * @var string
     */
    protected $resourcePluralName = 'tokens/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\TokenModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\TokenModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\TokenModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\TokenModel
     */
