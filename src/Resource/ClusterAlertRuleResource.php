...
class ClusterAlertRuleResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'clusterAlertRule/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'clusterAlertRules/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterAlertRuleModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath(true, false) . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\ClusterAlertRuleModel');
    }

    /**
     * create
     *
     * @param \Rancher\Model\ClusterAlertRuleModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\ClusterAlertRuleModel
     */
