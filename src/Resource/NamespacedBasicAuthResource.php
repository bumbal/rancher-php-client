...
class NamespacedBasicAuthResource
{
    /**
     * @var RancherClient
     */
     ...
     * @var string
     */
    protected $resourceName = 'namespacedBasicAuth/';

    /**
     * @var string
     */
    protected $resourcePluralName = 'namespacedBasicAuths/';
     ...
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedBasicAuthModel
     */
    public function get($id)
    {
        $response = $this->client->request('GET', $this->constructPath() . $id, []);

        return $this->client->getSerializer()->deserialize($response, '\Rancher\Model\NamespacedBasicAuthModel');
    }

    /**
     * set
     *
     * @param \Rancher\Model\NamespacedBasicAuthModel $data
     *
     * @throws RancherException
     * @return \Rancher\Model\NamespacedBasicAuthModel
     */
