...
class ProjectAlertRuleFilter extends AbstractFilter
{
    /**
     * Gets alertState
     * @return string
     ...
     * @return $this
     */
    public function setAlertState($alertState, $option = '')
    {
        ...
        $this->container['alertState'.$option] = $alertState;
     ...
     * @param string $groupIntervalSeconds
     * @param string $option
     * @return $this
     */
    public function setGroupIntervalSeconds($groupIntervalSeconds, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['groupIntervalSeconds'.$option] = $groupIntervalSeconds;
     ...
     * @param string $groupWaitSeconds
     * @param string $option
     * @return $this
     */
    public function setGroupWaitSeconds($groupWaitSeconds, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['groupWaitSeconds'.$option] = $groupWaitSeconds;
     ...
     * @return $this
     */
    public function setInherited($inherited, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['inherited'.$option] = $inherited;
     ...
     * @param string $repeatIntervalSeconds
     * @param string $option
     * @return $this
     */
    public function setRepeatIntervalSeconds($repeatIntervalSeconds, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['repeatIntervalSeconds'.$option] = $repeatIntervalSeconds;
     ...
     * @return $this
     */
    public function setSeverity($severity, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['severity'.$option] = $severity;
