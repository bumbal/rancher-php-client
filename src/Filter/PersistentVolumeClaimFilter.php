...
class PersistentVolumeClaimFilter extends AbstractFilter
{
    /**
     * Gets created
     * @return string
     ...
     * @return $this
     */
    public function setVolumeId($volumeId, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['volumeId'.$option] = $volumeId;
