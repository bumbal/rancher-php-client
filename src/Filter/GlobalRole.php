...
class GlobalRole extends AbstractFilter
{
    /**
     * Gets created
     * @return string
    ...
    /**
     * Sets newUserDefault
     * @param string $newUserDefault
     * @param string $option
     * @return $this
     */
    public function setNewUserDefault($newUserDefault, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['newUserDefault'.$option] = $newUserDefault;
