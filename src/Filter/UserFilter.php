...
class UserFilter extends AbstractFilter
{
     ...
     * @return $this
     */
    public function setMustChangePassword($mustChangePassword, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['mustChangePassword'.$option] = $mustChangePassword;
     ...
     * @return $this
     */
    public function setPassword($password, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['password'.$option] = $password;
     ...
     * @return $this
     */
    public function setUsername($username, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['username'.$option] = $username;
