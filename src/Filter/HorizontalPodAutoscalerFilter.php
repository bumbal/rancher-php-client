...
class HorizontalPodAutoscalerFilter extends AbstractFilter
{
    /**
     * Gets created
     * @return string
     ...
     * @param string $currentReplicas
     * @param string $option
     * @return $this
     */
    public function setCurrentReplicas($currentReplicas, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['currentReplicas'.$option] = $currentReplicas;
     ...
     * @param string $desiredReplicas
     * @param string $option
     * @return $this
     */
    public function setDesiredReplicas($desiredReplicas, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['desiredReplicas'.$option] = $desiredReplicas;
    ...
    /**
     * Sets lastScaleTime
     * @param string $lastScaleTime
     * @param string $option
     * @return $this
     */
    public function setLastScaleTime($lastScaleTime, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['lastScaleTime'.$option] = $lastScaleTime;
    ...
    /**
     * Sets maxReplicas
     * @param string $maxReplicas
     * @param string $option
     * @return $this
     */
    public function setMaxReplicas($maxReplicas, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['maxReplicas'.$option] = $maxReplicas;
    ...
    /**
     * Sets minReplicas
     * @param string $minReplicas
     * @param string $option
     * @return $this
     */
    public function setMinReplicas($minReplicas, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['minReplicas'.$option] = $minReplicas;
     ...
     * @return $this
     */
    public function setObservedGeneration($observedGeneration, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['observedGeneration'.$option] = $observedGeneration;
