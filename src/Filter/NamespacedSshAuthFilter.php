...
class NamespacedSshAuthFilter extends AbstractFilter
{
    /**
     ...
     * @return $this
     */
    public function setPrivateKey($privateKey, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['privateKey'.$option] = $privateKey;
