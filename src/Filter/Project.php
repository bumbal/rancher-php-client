...
class Project extends AbstractFilter
{
    /**
     * Gets clusterId
     * @return string
     ...
     * @param string $enableProjectMonitoring
     * @param string $option
     * @return $this
     */
    public function setEnableProjectMonitoring($enableProjectMonitoring, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['enableProjectMonitoring'.$option] = $enableProjectMonitoring;
