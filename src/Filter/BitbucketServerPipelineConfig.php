...
class BitbucketServerPipelineConfig extends AbstractFilter
{
    /**
     * Gets consumerKey
     * @return string
     ...
     * @return $this
     */
    public function setConsumerKey($consumerKey, $option = '')
    {
        ...
        $this->container['consumerKey'.$option] = $consumerKey;
     ...
     * @return $this
     */
    public function setPublicKey($publicKey, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['publicKey'.$option] = $publicKey;
     ...
     * @return $this
     */
    public function setRedirectUrl($redirectUrl, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['redirectUrl'.$option] = $redirectUrl;
