...
class ClusterTemplateFilter extends AbstractFilter
{
    /**
     * Gets created
     * @return string
     ...
     * @return $this
     */
    public function setDefaultRevisionId($defaultRevisionId, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['defaultRevisionId'.$option] = $defaultRevisionId;
