...
class ClusterCatalogFilter extends AbstractFilter
{
    /**
     * Gets branch
     * @return string
     ...
     * @return $this
     */
    public function setLastRefreshTimestamp($lastRefreshTimestamp, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['lastRefreshTimestamp'.$option] = $lastRefreshTimestamp;
