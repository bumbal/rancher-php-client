...
class MonitorMetricFilter extends AbstractFilter
{
    /**
     * Gets created
     * @return string
     ...
     * @return $this
     */
    public function setExpression($expression, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['expression'.$option] = $expression;
     ...
     * @return $this
     */
    public function setLegendFormat($legendFormat, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['legendFormat'.$option] = $legendFormat;
