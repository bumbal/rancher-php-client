...
class ComposeConfigFilter extends AbstractFilter
{
    /**
     * Gets created
     * @return string
     ...
     * @return $this
     */
    public function setRancherCompose($rancherCompose, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['rancherCompose'.$option] = $rancherCompose;
