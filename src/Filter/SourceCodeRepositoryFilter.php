...
class SourceCodeRepositoryFilter extends AbstractFilter
{
    /**
     * Gets created
     * @return string
     ...
     * @return $this
     */
    public function setDefaultBranch($defaultBranch, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['defaultBranch'.$option] = $defaultBranch;
     ...
     * @return $this
     */
    public function setLanguage($language, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['language'.$option] = $language;
