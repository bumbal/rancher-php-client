...
/**
 * ClusterRegistrationTokenFilter
 *
 * @category Class
 * @package  Rancher
...
class ClusterRegistrationTokenFilter extends AbstractFilter
{
    /**
     * Gets clusterId
     * @return string
     ...
     * @return $this
     */
    public function setCommand($command, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['command'.$option] = $command;
     ...
     * @return $this
     */
    public function setInsecureCommand($insecureCommand, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['insecureCommand'.$option] = $insecureCommand;
     ...
     * @return $this
     */
    public function setManifestUrl($manifestUrl, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['manifestUrl'.$option] = $manifestUrl;
     ...
     * @return $this
     */
    public function setNodeCommand($nodeCommand, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['nodeCommand'.$option] = $nodeCommand;
     ...
     * @return $this
     */
    public function setWindowsNodeCommand($windowsNodeCommand, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['windowsNodeCommand'.$option] = $windowsNodeCommand;
