...
/**
 * PodSecurityPolicyTemplateProjectBindingFilter
 *
 * @category Class
 * @package  Rancher
...
class PodSecurityPolicyTemplateProjectBindingFilter extends AbstractFilter
{
    /**
     * Gets created
     * @return string
     ...
     * @return $this
     */
    public function setPodSecurityPolicyTemplateId($podSecurityPolicyTemplateId, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['podSecurityPolicyTemplateId'.$option] = $podSecurityPolicyTemplateId;
     ...
     * @return $this
     */
    public function setTargetProjectId($targetProjectId, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['targetProjectId'.$option] = $targetProjectId;
