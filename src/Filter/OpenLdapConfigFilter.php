...
class OpenLdapConfigFilter extends AbstractFilter
{
    /**
     * Gets accessMode
     * @return string
     ...
     * @return $this
     */
    public function setServiceAccountDistinguishedName($serviceAccountDistinguishedName, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
     ...
     * @return $this
     */
    public function setUserMemberAttribute($userMemberAttribute, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['userMemberAttribute'.$option] = $userMemberAttribute;
