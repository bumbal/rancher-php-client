...
class GlobalRoleBindingFilter extends AbstractFilter
{
    /**
     * Gets created
     * @return string
    ...
    {
        return $this->container['globalRoleId'];
    }
     ...
     * @return $this
     */
    public function setGlobalRoleId($globalRoleId, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['globalRoleId'.$option] = $globalRoleId;
