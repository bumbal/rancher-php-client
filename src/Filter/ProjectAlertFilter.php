...
class ProjectAlertFilter extends AbstractFilter
{
    /**
     * Gets created
     * @return string
     ...
     * @param string $initialWaitSeconds
     * @param string $option
     * @return $this
     */
    public function setInitialWaitSeconds($initialWaitSeconds, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['initialWaitSeconds'.$option] = $initialWaitSeconds;
