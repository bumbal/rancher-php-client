...
class GithubPipelineConfigFilter extends AbstractFilter
{
    /**
     * Gets clientId
     * @return string
     ...
     * @return $this
     */
    public function setInherit($inherit, $option = '')
    {
        if(!empty($option) && in_array($option, $this->allowedOptions))
        {
            $option = '_'.$option;
        ...
        $this->container['inherit'.$option] = $inherit;
